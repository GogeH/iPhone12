const accordion = () => {
  const characteristicsListElement = document.querySelector('.js-characteristics-list');
  const characteristicsItemElements = document.querySelectorAll('.js-characteristics-item');

  characteristicsItemElements.forEach((elem) => {
  ...
  characteristicsListElement.addEventListener('click', (event) => {
    const {target} = event;
